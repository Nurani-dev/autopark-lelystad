            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    >
                        ...
                        <div className="absolute -top-4 -left-4 w-24 h-24 border-t-2 border-l-2 border-gold-gradient/50 z-0" />
                        <div className="absolute -bottom-12 -right-12 w-32 h-32 border-b-2 border-r-2 border-gold-gradient/50 z-0" />
                    </motion.div>
                    ...
                    >
                        <h2 className="text-gold-gradient text-sm font-bold uppercase tracking-widest mb-2">Over Autopark Lelystad</h2>
                        <h3 className="text-3xl md:text-4xl font-bold text-white uppercase tracking-tight mb-6">
                            Passie voor <span className="text-gold-gradient">Exclusiviteit</span>
                        </h3>
                        ...
                        <div className="space-y-4 mb-10">
                            {[
                                ...
                                <div key={item} className="flex items-center gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-gold-gradient" />
                        ...
                        <Link
                            href="/over-ons"
                            className="inline-flex items-center gap-2 text-white font-bold uppercase tracking-wide hover:text-gold-gradient transition-colors group"
                        >
                            Lees ons verhaal <ArrowRight className="w-5 h-5 transition-transform group-hover:translate-x-1 text-gold-gradient group-hover:text-gold-gradient" />
                        </Link>
                    </motion.div>
                </div>
            </div>
