                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.snapchat.com/add/autoparklelystd" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gold/10 hover:text-gold transition-all group border border-transparent hover:border-gold">
                                <svg viewBox="0 0 496 512" className="w-5 h-5 fill-current text-white group-hover:text-gold transition-colors">
                            ...
                            <a href="https://www.instagram.com/autoparklelystad" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gold/10 hover:text-gold transition-all group border border-transparent hover:border-gold">
                                <Instagram className="w-5 h-5 text-white group-hover:text-gold transition-colors" />
                            </a>
                            <a href="https://www.tiktok.com/@autoparklelystad" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-gold/10 hover:text-gold transition-all group border border-transparent hover:border-gold">
                                <svg viewBox="0 0 32 32" className="w-5 h-5 fill-current text-white group-hover:text-gold transition-colors">
