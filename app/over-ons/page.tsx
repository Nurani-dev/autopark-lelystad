                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <h2 className="text-4xl md:text-5xl font-bold leading-tight text-foreground">
                                Passie voor <span className="inline-block text-silver-sheen text-3xl md:text-4xl">Techniek</span> & <br />
                                <span className="inline-block text-silver-sheen text-3xl md:text-4xl mt-2">Kwaliteit</span>.
                            </h2>
