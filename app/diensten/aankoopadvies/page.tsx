                ...
                <div className="container mx-auto px-4 relative z-10">
                        ...
                        >
                            ...
                            <div className="relative w-full max-w-[500px] aspect-square flex items-center justify-center">
                                ...
                                <div className="w-2/3 h-2/3 bg-gold/5 backdrop-blur-sm rounded-full flex items-center justify-center relative z-10">
                                    <Car className="w-1/2 h-1/2 text-gold" />
                                </div>
                                {/* Glow - Reduced */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                        <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:border-gold/30 transition-colors group">
                            <Search className="w-10 h-10 text-gold mb-6 group-hover:scale-110 transition-transform" />
                            <h4 className="text-xl font-bold text-white mb-3">Zoekopdracht</h4>
                            <p className="text-gray-400 leading-relaxed">Wij scannen de internationale markt naar de auto die exact aan uw specificaties voldoet.</p>
                        </div>
                        <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:border-gold/30 transition-colors group">
                            <FileSearch className="w-10 h-10 text-gold mb-6 group-hover:scale-110 transition-transform" />
                            <h4 className="text-xl font-bold text-white mb-3">Inspectie & Historie</h4>
                            <p className="text-gray-400 leading-relaxed">Grondige controle van de technische staat, schadeverleden en kilometerstand.</p>
                        </div>
                        <div className="bg-white/5 p-8 rounded-xl border border-white/10 hover:border-gold/30 transition-colors group">
                            <Handshake className="w-10 h-10 text-gold mb-6 group-hover:scale-110 transition-transform" />
                            <h4 className="text-xl font-bold text-white mb-3">Onderhandeling</h4>
                            <p className="text-gray-400 leading-relaxed">Wij voeren de prijsonderhandelingen voor u om de beste deal te garanderen.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-8 md:p-16 mb-20">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                            {/* Left: Heading & CTA */}
                            <div>
                                <h4 className="text-3xl font-bold text-white mb-6">Waarom Kiezen voor Aankoopadvies?</h4>
